...
class ImagenDetail : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_imagen_detail)
    ...
    private fun downloadImage(url: String) {
        ...
        var nameLong =  url.substring(url.lastIndexOf("/") + 1)
        val nameShort = nameLong.substringAfter("%2F").substringBefore('?')

        val request = DownloadManager.Request(downloadUri).apply {
            setAllowedNetworkTypes(DownloadManager.Request.NETWORK_WIFI or DownloadManager.Request.NETWORK_MOBILE)
                .setAllowedOverRoaming(false)
                .setDestinationInExternalPublicDir(
                    "JyC_Pictures",nameShort
                )
        }
